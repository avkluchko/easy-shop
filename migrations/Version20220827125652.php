...
final class Version20220827125652 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE goods (id INT NOT NULL, id_catalog INT NOT NULL, id_measure INT NOT NULL, hidden BOOLEAN NOT NULL, name VARCHAR(255) NOT NULL, quantity NUMERIC(10, 3) NOT NULL, price NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id))');
